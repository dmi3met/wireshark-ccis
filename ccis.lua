...
function get_opcode_name(opcode)
    ...
    elseif opcode == 2 then opcode_name = "24--"
    elseif opcode == 3 then opcode_name = "24--"
    elseif opcode == 4 then opcode_name = "24--"
    elseif opcode == 5 then opcode_name = "24--"
    elseif opcode == 6 then opcode_name = "24--"
    elseif opcode == 7 then opcode_name = "BYE"
    elseif opcode == 8 then opcode_name = "OK"
    elseif opcode == 9 then opcode_name = "24--"
    elseif opcode == 10 then opcode_name = "24--"
    elseif opcode == 11 then opcode_name = "24--"
    elseif opcode == 12 then opcode_name = "24--"
    elseif opcode == 13 then opcode_name = "24--"
    elseif opcode == 14 then opcode_name = "24--"
    elseif opcode == 15 then opcode_name = "24--"
    elseif opcode == 16 then opcode_name = "24--"
    elseif opcode == 17 then opcode_name = "24--"
    elseif opcode == 18 then opcode_name = "24--"
    elseif opcode == 19 then opcode_name = "24--"
	elseif opcode == 20 then opcode_name = "24--"
    elseif opcode == 21 then opcode_name = "24--"
    elseif opcode == 22 then opcode_name = "24--"
    elseif opcode == 23 then opcode_name = "24--"
    elseif opcode == 24 then opcode_name = "24--"
    elseif opcode == 25 then opcode_name = "24--"
    ...
    elseif opcode == 29 then opcode_name = "28--"
    elseif opcode == 30 then opcode_name = "28--"
    elseif opcode == 31 then opcode_name = "28--"
    elseif opcode == 32 then opcode_name = "28--"
    elseif opcode == 33 then opcode_name = "28--"
    elseif opcode == 34 then opcode_name = "28--"
    elseif opcode == 35 then opcode_name = "28--"
    elseif opcode == 36 then opcode_name = "28--"
    elseif opcode == 37 then opcode_name = "28--"
    elseif opcode == 38 then opcode_name = "28--"
    elseif opcode == 39 then opcode_name = "28--"
    elseif opcode == 40 then opcode_name = "28--"
    elseif opcode == 41 then opcode_name = "28--"
    elseif opcode == 42 then opcode_name = "28--"
    elseif opcode == 43 then opcode_name = "28--"
    elseif opcode == 44 then opcode_name = "28--"
    elseif opcode == 45 then opcode_name = "28--"
    elseif opcode == 46 then opcode_name = "28--"
    elseif opcode == 47 then opcode_name = "28--"
    elseif opcode == 48 then opcode_name = "28--"
    elseif opcode == 49 then opcode_name = "28--"
    elseif opcode == 50 then opcode_name = "28--"
    elseif opcode == 51 then opcode_name = "28--"
    elseif opcode == 52 then opcode_name = "28--"
    elseif opcode == 53 then opcode_name = "28--"
    elseif opcode == 54 then opcode_name = "28--"
    elseif opcode == 55 then opcode_name = "28--"
    elseif opcode == 56 then opcode_name = "28--"
    elseif opcode == 57 then opcode_name = "28--"
    elseif opcode == 58 then opcode_name = "28--"
    elseif opcode == 59 then opcode_name = "28--"
    elseif opcode == 60 then opcode_name = "28--"
    elseif opcode == 61 then opcode_name = "28--"
    elseif opcode == 62 then opcode_name = "28--"
	elseif opcode == 63 then opcode_name = "INVITE"
